      ...
      <div className="mx-auto max-w-md p-8 border border-gray-200 rounded-2xl shadow-sm">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div>
                ...
                <input id="name" name="first_name" type="text" required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" onChange={handleChange} />
            </div>
            <div>
